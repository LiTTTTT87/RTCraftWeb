<template>
    <n-space justify="center">
        <n-card title=" " class="_cord">
            <img src="/register.png" alt="register_png" class="_pic">
            <template #footer>
                <n-space vertical>
            ...
            <template #action>
                <n-space justify="space-around" size="large">
                    <n-button-group>
                        <n-button ghost type="info" size="large" :onclick="register">
                            <template #icon>
                                <n-icon>
                                    <PersonAdd24Filled />
                                </n-icon>
...
<script setup>
import { CaretRight24Filled, PersonAdd24Filled } from "@vicons/fluent";
import { ReturnDownBack } from '@vicons/ionicons5'
import { ref } from 'vue';
import { doregister } from "../../utils/oauth";
...
function register() {
    doregister(user.value, password.value)
}
</script>
<style>
._cord {
